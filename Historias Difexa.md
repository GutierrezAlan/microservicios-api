...
GET    /api/publications/{id}               \# Ver detalles de publicación

PUT    /api/publications/{id}               \# Actualizar publicación completa

PATCH  /api/publications/{id}               \# Actualizar campos específicos
...
POST   /api/publications/{id}/restore
